package com.waps.pawnshop.gallery;
...
public class ImageAdapter extends BaseAdapter {
	...
	public static int ImageH = 400;
	public static int ImageW = 300;
	...
	public boolean createReflectedImages() {
		...
		for (int imageId : mImageIds) {
			...
			imageView.setLayoutParams(new GalleryFlow.LayoutParams(ImageW,
					ImageH));
